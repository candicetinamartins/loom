...
export class LoomResearcherAgent extends LoomAgentBase {
  readonly id = 'loom-researcher'
  readonly name = 'researcher'
  readonly description = 'Documentation, APIs, current best practices research'
  readonly model = 'perplexity/sonar-pro'
  readonly thinkingBudget = 1000
  readonly toolGroups = ['web', 'graph', 'memory']

  getSystemPrompt(): string {
    return `You are the Researcher agent for Loom.

Your role is to research documentation, APIs, and current best practices.
