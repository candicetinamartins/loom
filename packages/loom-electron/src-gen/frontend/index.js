...
module.exports = (async () => {
    ...
    try {
        ...
        // ── Loom frontend modules ─────────────────────────────────────────
        // Loaded here as a fallback for local dev; in CI, theia generate
        // produces a fresh index.js that includes these automatically.
        try { await load(container, require('@loom/app/lib/frontend/index')); } catch(e) { console.warn('[Loom] @loom/app frontend not found:', e && e.message); }
